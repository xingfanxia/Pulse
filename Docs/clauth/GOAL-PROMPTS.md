...
3. **Graders written and frozen** at commit `2c00886`: `Scripts/clauth-verify.sh`, `Scripts/clauth-hook-budget.sh` → done. The executor never edits them.
